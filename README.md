...
1. 💪 Opened PR [#55](https://github.com/hmrc/address-lookup/pull/55) in [hmrc/address-lookup](https://github.com/hmrc/address-lookup)
2. 💪 Opened PR [#125](https://github.com/hmrc/address-lookup-frontend/pull/125) in [hmrc/address-lookup-frontend](https://github.com/hmrc/address-lookup-frontend)
3. 💪 Opened PR [#6](https://github.com/hmrc/address-lookup-frontend-acceptance-tests/pull/6) in [hmrc/address-lookup-frontend-acceptance-tests](https://github.com/hmrc/address-lookup-frontend-acceptance-tests)
4. 🎉 Merged PR [#4](https://github.com/hmrc/address-lookup-non-uk-ingest-lambda-function/pull/4) in [hmrc/address-lookup-non-uk-ingest-lambda-function](https://github.com/hmrc/address-lookup-non-uk-ingest-lambda-function)
5. 💪 Opened PR [#5](https://github.com/hmrc/address-lookup-frontend-acceptance-tests/pull/5) in [hmrc/address-lookup-frontend-acceptance-tests](https://github.com/hmrc/address-lookup-frontend-acceptance-tests)
